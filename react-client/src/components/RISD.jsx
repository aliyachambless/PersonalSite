    ...
    return (
      <Container>
        ...
        <Hbox>
          ...
          <TextBlock>
            Create a word list + mood board for your record cover: what do you want to express? Is there a specific element or imagery from a song you want to highlight? How might you encapsulate the mood of a record? Is there a particular story about the record you want to express?
          </TextBlock>
        </Hbox>
        <Line/>
